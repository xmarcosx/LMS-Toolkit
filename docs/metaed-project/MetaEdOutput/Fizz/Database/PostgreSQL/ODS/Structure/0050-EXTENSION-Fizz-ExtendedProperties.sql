...
COMMENT ON COLUMN fizz.Assignment.StartDateTime IS 'The start date and time for the assignment. Students will have access to the assignment after this date.';
COMMENT ON COLUMN fizz.Assignment.EndDateTime IS 'The end date and time for the assignment. Students will no longer have access to the assignment after this date.';
COMMENT ON COLUMN fizz.Assignment.DueDateTime IS 'The date and time the assignment is due.';
...
COMMENT ON COLUMN fizz.Assignment.DeletedAt IS 'The datetime the record EntityStatus was changed to deleted.';

-- Extended Properties [fizz].[AssignmentSubmission] --
COMMENT ON TABLE fizz.AssignmentSubmission IS 'A user''s submission of course work for an assignment.';
...
COMMENT ON COLUMN fizz.AssignmentSubmission.Status IS 'The status of the submission in relation to the late acceptance policy.';
COMMENT ON COLUMN fizz.AssignmentSubmission.SubmissionDateTime IS 'The date and time of the assignment submission.';
...
COMMENT ON COLUMN fizz.AssignmentSubmission.DeletedAt IS 'The datetime the record EntityStatus was changed to deleted.';

-- Extended Properties [fizz].[AssignmentSubmissionType] --
COMMENT ON TABLE fizz.AssignmentSubmissionType IS 'The type(s) of submissions available for the assignment.';
...
COMMENT ON COLUMN fizz.AssignmentSubmissionType.SubmissionType IS 'The type(s) of submissions available for the assignment.';

-- Extended Properties [fizz].[LMSGrade] --
COMMENT ON TABLE fizz.LMSGrade IS 'A grade assigned to a user in a section.';
...
COMMENT ON COLUMN fizz.LMSGrade.Grade IS 'The user''s letter or numeric grade for the section.';
...
COMMENT ON COLUMN fizz.LMSGrade.DeletedAt IS 'The datetime the record EntityStatus was changed to deleted.';

-- Extended Properties [fizz].[LMSSection] --
COMMENT ON TABLE fizz.LMSSection IS 'An organized grouping of course content and users over a period of time for the purpose of providing instruction.';
...
COMMENT ON COLUMN fizz.LMSSection.DeletedAt IS 'The datetime the record EntityStatus was changed to deleted.';

-- Extended Properties [fizz].[User] --
COMMENT ON TABLE fizz.User IS 'A person using the instructional system.';
...
COMMENT ON COLUMN fizz.User.DeletedAt IS 'The datetime the record EntityStatus was changed to deleted.';
...
COMMENT ON COLUMN fizz.UserAttendanceEvent.DeletedAt IS 'The datetime the record EntityStatus was changed to deleted.';

-- Extended Properties [fizz].[UserLMSActivity] --
COMMENT ON TABLE fizz.UserLMSActivity IS 'An activity performed by a user within the instructional system.';
...
COMMENT ON COLUMN fizz.UserLMSActivity.DeletedAt IS 'The datetime the record EntityStatus was changed to deleted.';

-- Extended Properties [fizz].[UserLMSSectionAssociation] --
COMMENT ON TABLE fizz.UserLMSSectionAssociation IS 'The association of a user and section. For a student, this would be a section enrollment. For a teacher, this would be a section assignment.';
...
COMMENT ON COLUMN fizz.UserLMSSectionAssociation.DeletedAt IS 'The datetime the record EntityStatus was changed to deleted.';
